...
'Intelligent Solutions Powered by AI.':'O caminho para transformar sua clínica em uma operação de alta performance.',
'Gain clarity and harness the power of your data with RedSun. Our intuitive dashboard provides real-time analytics.':'Um sistema integrado de precificação, posicionamento, vendas, gestão e processos para transformar demanda em mais margem, previsibilidade e capacidade de escala.',
...
extra+='<section id="depoimentos" class="section pac-extra"><div class="container"><div class="section-paddings"><div class="section-center-text"><p class="pac-kicker">Depoimentos</p><h2 class="title medium">Resultados reais de mentorados</h2></div><div class="pac-video-testimonials"><div class="video-testimonial-card"><video controls preload="none" poster="images/depoimento-aline-pavan-poster.jpg" aria-label="Depoimento Aline Pavan"><source src="images/depoimento-aline-pavan.mp4" type="video/mp4"></video><p class="video-caption">Aline Pavan</p></div><div class="video-testimonial-card"><video controls preload="none" poster="images/depoimento-henrique-cruvinel-poster.jpg" aria-label="Depoimento Henrique Cruvinel"><source src="images/depoimento-henrique-cruvinel.mp4" type="video/mp4"></video><p class="video-caption">Henrique Cruvinel</p></div></div></div></div></section>'
